    ...
    // update the callback
        ...
        try {
            let result = await dialog.showMessageBox(mainWindow, {
                ...
                message: localizeMessage('main.app.app.handleAppCertificateError.certError.dialog.message', 'There is a problem with the security certificate for this server or for embedded content in a message. Please contact your Teamost admin or IT department to resolve this issue.'),
                type: 'error',
                detail,
                buttons: [
